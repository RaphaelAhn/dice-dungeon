...
export const VEGGIES: Topping[] = [
  ...make('veg', 'mild', ['양송이버섯', '옥수수', '애호박', '감자', '콜리플라워', '완두콩']),
  ...make('veg', 'spicy', ['할라피뇨', '페페론치노', '청양고추', '홍고추', '마늘', '양파']),
  ...make('veg', 'tangy', ['방울토마토', '파인애플', '그린올리브', '피클', '선드라이토마토', '레몬제스트']),
  ...make('veg', 'herbal', ['바질', '루꼴라', '시금치', '오레가노', '파슬리', '로즈마리']),
  ...make('veg', 'rich', ['가지', '아티초크', '트러플', '블랙올리브', '구운파프리카', '표고버섯']),
]
